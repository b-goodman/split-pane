...
class SplitPane extends HTMLElement {
    ...
    attributeChangedCallback(name, _oldVal, newVal) {
        ...
        if (name === "direction" && _oldVal !== null) {
            if (Object.keys(Direction).includes(newVal)) {
                const wrapper = this.shadowRoot.querySelector("div#flex");
    ...
    get direction() {
        return this.getAttribute("direction") || Direction.horizontal;
    }
    get key() {
    ...
    get currentPaneSize() {
        ...
        return attr ? JSON.parse(attr) : this.defaultPaneSize;
    }
    set currentPaneSize(newPaneSizes) {
    ...
    initSplit() {
        this.split = Split(this.paneElements, {
